...
my repos are private now but the products are live. (286 hours & 44.7B tokens :D) <br> 
### live on the web
...
- **msducky** - a doctor's site, region of the day plus a weekly mail so patients keep moving. html. [msducky.noseydewdrop.com](https://msducky.noseydewdrop.com)
...
- **moonlight** - moon phases, horary, astrology. swift
- **sunflower** - simple pomodoro and study timer. swift
...
- **insta-analyzer** - who follows you but never likes your photos. python

### i used to grind on leetcode before ai, and i was a ta for py. these are my notes.
- **fantaisie-impromptu** - leetcode, exercism and ta notes archive. java
