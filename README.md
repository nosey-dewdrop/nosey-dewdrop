...
i won't be writing any new projects. i have 13-14 finished projects on ios, web, java, python. i have **llm** trained face recognition model, many project uses **api** from fal.ai, groq, claude api. also, i have 3 implementations with my own unique algorithms. i have one project using **cloud**.         
